            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 col-12">
                        ...
                        <h2 class="mt-2 mb-4"><span class="text-muted">Introducing</span> Home4u</h2>

                        <h4 class="text-muted mb-3">Since 1986, We crafted interior products for better spaces</h4>

                        <p>Moso Interior is a company for creating best decorations for your Home WITH satisfications designs.we're here to help you to make your dreams come true,you can imagine any design in a few days you will see it liveby our designers. Thank you for visiting.</p>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <small class="section-small-title">Home4u Design Shop</small>
                        ...
                        <div class="owl-carousel reviews-carousel">
                            <div class="reviews-thumb">
                                <div class="reviews-body">
                                    <h4>i get a perfect design and very fast thank you so much</h4>
                                </div>
                            ...
                            <div class="reviews-thumb">
                                <div class="reviews-body">
                                    <h4>they are very fast and always available to contact.</h4>
                                </div>
                            ...
                            <div class="reviews-thumb">
                                <div class="reviews-body">
                                    <h4>thank you for helping me in my home decoration.</h4>
                                </div>
                            ...
                            <div class="reviews-thumb">
                                <div class="reviews-body">
                                    <h4>you are the best company ever i've dealed with.</h4>
                                </div>
        ...
        <section class="contact-section" id="section_5">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <form class="custom-form contact-form" action="{{ route('mail.store') }}" method="POST" enctype="multipart/form-data">
                          @csrf
                            ...
                            <div class="input-group align-items-center">
                                ...
                                <input type="email" name="userEmail" id="userEmail" pattern="[^ @]*@[^ @]*" class="form-control" placeholder="Jackdoe@gmail.com" required>
                            </div>

                            <div class="input-group textarea-group">
                                <label for="message">Message</label>

                                <textarea name="description" rows="6" class="form-control" id="description" placeholder="What can we help you?"></textarea>
                            </div>
