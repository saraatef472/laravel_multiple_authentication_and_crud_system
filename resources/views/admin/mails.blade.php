...
<body>
  ...
  @endif
      ...
      <div class="app-content-header">
        <h1 class="app-content-headerText">Mails</h1>
      ...
      <div class="app-content-actions">
        ...
        <input class="search-bar" name="search" id="search" placeholder="Search by name,desc,price..." type="text">
      ...
      <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>  <form action="{{ route('admin.deleteMail',$mail->id) }}" method="POST">
              @csrf
              @method('DELETE')
