  ...
  <div class="app-container">
    ...
    <div class="sidebar">
      ...
      <div class="account-info">
        ...
        </div>          <button class="account-info-more">
  ...
  <form action="{{ route('admin.update', $products->id )}}" method="POST" enctype="multipart/form-data"> 
      ...
      @method('PUT')
       ...
       <div class="row">
          ...
          <div class="form-group">
            <strong>price:</strong>
            <input type="text" name="price" value="{{ $products->price }}" class="form-control" placeholder="Name">
        </div>
    </div>
          <div class="col-xs-12 col-sm-12 col-md-12">
              <div class="form-group">
                  <strong>Detail:</strong>
                  <textarea class="form-control" style="height:150px" name="description" placeholder="Detail">{{ $products->description }}</textarea>
              </div>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-12">
              <div class="form-group">
