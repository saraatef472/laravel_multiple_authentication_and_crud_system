...
<body>
  ...
  <div class="app-container">
    ...
    <div class="sidebar">
      ...
      <ul class="sidebar-list">
        ...
        <li class="sidebar-list-item">
          <a class="dropdown-item" href="{{ route('admin.logout') }}"
                      ...
                      <svg width="23" height="28" viewBox="0 0 24 24"fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"  class="icon">
                        <path d="M13.5 7.5L10.5 10.75M13.5 7.5L10.5 4.5M13.5 7.5L4 7.5M8 13.5H1.5L1.5 1.5L8 1.5"/>                      </svg>
      ...
      <div class="account-info">
        ...
        <div class="account-info-name"> {{ Auth::guard('admin')->user()->name }}
        </div>        </div>
        <a class="account-info-more" href="http://"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg></a>
      </div>
    </div>
  ...
  @endif
      ...
      <div class="app-content-actions">
        ...
        <input class="search-bar" name="search" id="search" placeholder="Search by name, desc,..." type="text">
